...
namespace Akshada.Repository
{
    ...
    {
        public NotificationScheduleRepository(AkshadaPawsContext akshadaPawsContext, IConfiguration configuration, IServiceProvider services) : base(akshadaPawsContext, configuration, services)
        {
        }
    }
}
